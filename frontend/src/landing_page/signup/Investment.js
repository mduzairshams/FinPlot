  ...
  return (
    <div className="container mt-5">
      <div className="row mt-5">
        <h3 style={{color:"#3c3c3c"}}>Investment options with Zerodha demat account</h3>
      ...
      <button className=' text-center p-2 fs-4  btn btn-primary mb-5' style={{width:"15%" , margin: "0 auto", fontWeight:"500" }}>Explore Investments </button>
    </div>
  );
}
