    ...
    return ( 
        ...
        <div className="row p-5">
            <div className="col-6">
                ...
                <p className='mb-4' style={{width: "80%", color:"lightgray"}}>That's why 1.6+ crore customers trust Zerodha with ~ ₹6 lakh crores of equity investments, making us India’s largest broker; contributing to 15% of daily retail exchange volumes in India.</p>
                ...
                <h3 style={{color:"gray"}}>The Zerodha universe</h3>
            ...
            <div className="col-6">
                <img src="media/images/ecosystem.png" style={{width: "100%"}} alt="EcosystemOfZerodha" />
